(function() {
  ...
  function captureLog(level, args) {
    ...
    try {
      ...
      // Silent fail - parent may not be ready
    }
  }
  ...
  window.addEventListener('error', function(event) {
    captureLog('error', [`Unhandled Error: ${event.error ? event.error.stack || event.error.message : event.message} at ${event.filename}:${event.lineno}:${event.colno}`]);
  });
